...
-	The “next page” button must be changed for all carousel-items to:
o	 <input type="button" value="Nächste Seite" style="float: right;" data-bs-target="#carouselControls" data-bs-slide="next" /> 
